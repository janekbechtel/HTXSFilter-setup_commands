...
cd ../../
seed="int($(date +%s)%100)"
cmsDriver.py Configuration/GenProduction/python/HIG-RunIIFall17wmLHEGS-HTXS_ggH_110-111-112-113_fragment.py --fileout file:HIG-RunIIFall17wmLHEGS-HTXS_ggH_110-111-112-113.root --mc --eventcontent RAWSIM,LHE --datatier GEN-SIM,LHE --conditions 93X_mc2017_realistic_v3 --beamspot Realistic25ns13TeVEarly2017Collision --step LHE,GEN,SIM --nThreads 8 --geometry DB:Extended --era Run2_2017 --python_filename HIG-RunIIFall17wmLHEGS-HTXS_ggH_110-111-112-113.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring --customise_commands "process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=${seed}\nprocess.schedule = cms.Schedule(process.lhe_step,process.generation_step,process.filter_step,process.genfiltersummary_step,process.simulation_step,process.endjob_step,process.RAWSIMoutput_step,process.LHEoutput_step)\nprocess.genstepfilter.triggerConditions=cms.vstring(\"filter_step\")\nprocess.RAWSIMoutput.SelectEvents.SelectEvents = cms.vstring(\"filter_step\")" -n 2458
